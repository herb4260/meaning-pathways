...
configural <- paste0('
meaning_t1 =~ meaning1_t1 + meaning2_t1 + meaning3_t1 + meaning4_t1
meaning_t2 =~ meaning1_t2 + meaning2_t2 + meaning3_t2 + meaning4_t2
meaning_t3 =~ meaning1_t3 + meaning2_t3 + meaning3_t3 + meaning4_t3
meaning_t4 =~ meaning1_t4 + meaning2_t4 + meaning3_t4 + meaning4_t4
recovery_t1 =~ recovery1_t1 + recovery2_t1 + recovery3_t1 + recovery4_t1
recovery_t2 =~ recovery1_t2 + recovery2_t2 + recovery3_t2 + recovery4_t2
recovery_t3 =~ recovery1_t3 + recovery2_t3 + recovery3_t3 + recovery4_t3
recovery_t4 =~ recovery1_t4 + recovery2_t4 + recovery3_t4 + recovery4_t4
', resid_cor)

metric <- paste0('
meaning_t1 =~ lm1*meaning1_t1 + lm2*meaning2_t1 + lm3*meaning3_t1 + lm4*meaning4_t1
meaning_t2 =~ lm1*meaning1_t2 + lm2*meaning2_t2 + lm3*meaning3_t2 + lm4*meaning4_t2
meaning_t3 =~ lm1*meaning1_t3 + lm2*meaning2_t3 + lm3*meaning3_t3 + lm4*meaning4_t3
meaning_t4 =~ lm1*meaning1_t4 + lm2*meaning2_t4 + lm3*meaning3_t4 + lm4*meaning4_t4
recovery_t1 =~ lr1*recovery1_t1 + lr2*recovery2_t1 + lr3*recovery3_t1 + lr4*recovery4_t1
recovery_t2 =~ lr1*recovery1_t2 + lr2*recovery2_t2 + lr3*recovery3_t2 + lr4*recovery4_t2
recovery_t3 =~ lr1*recovery1_t3 + lr2*recovery2_t3 + lr3*recovery3_t3 + lr4*recovery4_t3
recovery_t4 =~ lr1*recovery1_t4 + lr2*recovery2_t4 + lr3*recovery3_t4 + lr4*recovery4_t4
', resid_cor)
